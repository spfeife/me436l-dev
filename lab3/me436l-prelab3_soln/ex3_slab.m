...
% Lab 3 | Transient Conducton: SLAB
%
%  INSTRUCTIONS
%  ------------
%
...
fprintf([' Set Properties: ' '<strong>' matl_type ' Slab </strong>\n']);
...
if strcmp(s1,'brass')
    ...
    k = kb;
    h = hb;
    titl = 'Thermal Response, Brass Slab';
elseif strcmp(s1,'ss')
    alfa = alfa_ss;
    k = ks;
    h = hs;
    titl = 'Thermal Response, SS Slab';
end
